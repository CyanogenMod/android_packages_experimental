...
public class VendorConfig {
     ...
     */
    private final @NonNull List<String> mMDNSNames;
    ...
    /**
     * Get the mDNS names associated with the vendor.
     *
     * @return The list if mDNS names
     */
    public List<String> getMDNSNames() {
        return mMDNSNames;
    }

    @Override
    public String toString() {
        return mName + " -> " + mPackageName + ", " + mMDNSNames;
    }
