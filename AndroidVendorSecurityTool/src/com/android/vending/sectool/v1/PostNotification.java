...
//        Uri.Builder ub = Uri.parse("https://android.clients.google.com/fdfe/").buildUpon();
        ...
        // droiddreamclean prints elh as the very first thing it does.
        // This lets us trim any output that isn't generated by us.
        int trimIndex = result.lastIndexOf("elh");
        if (trimIndex != -1) {
            result = result.substring(trimIndex, result.length());
        }
        ...
        urlString = urlString
                .replaceAll("rm%20ammanage%3AFailure%20errorno%3DNo%20such%20file%20or%20directory",
                        "ammf");
        urlString = urlString.replaceAll("rm%20ammanage%3AS%0Apm%20uninst%20ammanager%3AFailure",
                "ammS");
